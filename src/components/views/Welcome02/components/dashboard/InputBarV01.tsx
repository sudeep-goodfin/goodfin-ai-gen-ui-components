...
import { FileText, Calendar, Briefcase, X } from 'lucide-react';
...
export function InputBarV01({ currentMode = 'default', extraSlotItem, onModeChange }: InputBarProps) {
            ...
            <div className="flex gap-[4px] items-center flex-wrap">
              ...
              <Chip
                ...
                icon={
                  <Wrapper>
                    <defs>
                      <clipPath id="clip_news_v01">
                        <rect width="20" height="20" fill="white" />
                      </clipPath>
                    </defs>
                    <g clipPath="url(#clip_news_v01)">
              ...
              <Chip
                ...
                icon={
                  <Wrapper>
                    <defs>
                      <clipPath id="clip_more_v01">
                        <rect width="20" height="20" fill="white" />
                      </clipPath>
                    </defs>
                    <g clipPath="url(#clip_more_v01)">
              ...
              <div className="flex items-center justify-center size-[28px] rounded-[40px] hover:bg-gray-100 cursor-pointer transition-colors">
                <div className="relative shrink-0 size-[18px]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 18">
                    <defs>
                      <clipPath id="clip_mic_v01">
                        <rect fill="white" height="18" width="18" />
                      </clipPath>
                    </defs>
                    <g clipPath="url(#clip_mic_v01)">
